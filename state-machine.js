...
State.prototype.makeLink = function(){
    ...
    this.link = makeIcon(icons.arrow, this.x + 80, this.y + 40, 14, 14)
                        .attr('fill','#888')
                        .attr('stroke','none')
                        .drag(move,start,end);
...
var unusual = new State("Awaiting Verdict", 600, 100);
var limbo = new State("Rejected", 200, 500);
var end = new State("Registered", 660, 500, true);

new Connection(start,middle,"Assigned to Attorney");
new Connection(middle, unusual,"Appeal");
new Connection(unusual,start,"Upheld");
new Connection(unusual, end,"Denied");
